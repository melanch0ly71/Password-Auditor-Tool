**Features**
  - Check passwords against multiple breached password lists
  -  Fast and interactive terminal display
  -  Separate safe passwords into a new text file
  -  Lightweight Python tool with no heavy dependencies
  -  Can scale with multiple password lists
